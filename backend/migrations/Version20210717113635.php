 ...
 */
final class Version20210717113635 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ebook (id INT AUTO_INCREMENT NOT NULL, id_author INT DEFAULT NULL, title VARCHAR(30) NOT NULL, description VARCHAR(30) NOT NULL, year INT NOT NULL, cover VARCHAR(30) NOT NULL, language VARCHAR(30) NOT NULL, price DOUBLE PRECISION NOT NULL, url VARCHAR(30) NOT NULL, INDEX id_author (id_author), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE invoices DROP FOREIGN KEY FK_6A2F2F95800711A1');
        ...
        $this->addSql('ALTER TABLE invoices DROP FOREIGN KEY FK_6A2F2F956B3CA4B');
